    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white dark:bg-zinc-800 overflow-hidden shadow sm:rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-2">
          ...
          <ResourceBlock class="p-6 border-t border-zinc-200 dark:border-zinc-700 md:border-l" name="Vibrant Ecosystem">
            ...
            <a href="https://envoyer.io" class="underline">Envoyer</a> help you take your projects to the next level.
